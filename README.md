...
ROS 2 pacage template, to get started, use template by clicking on the Green button labeled [`Use this template`](https://github.com/jankovicsbendeguz/jan_h49_rand_avg/generate) / [`Create new repository`](https://github.com/jankovicsbendeguz/jan_h49_rand_avg/generate). 
...
- `jan_h49_rand_avg` >> `cool_ros2_package` (the folder was already renamed after `Use this template`)
